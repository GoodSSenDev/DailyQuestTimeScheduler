...
namespace DailyQuestTimeScheduler.Tests
{
    ...
    //        var testTaskHolderExpect = new NormalTaskHolder("Test", "this is testing2", true, 0b01010101, 1, 3214, DateTime.Now.Date);


    //        dBAccessClass.Setup(x => x.GetTaskHolderListAsync())
    //            .ReturnsAsync((new List<NormalTaskHolder>
    //            {  new NormalTaskHolder("Test", "this is testing2", true, 0b01010101, 1, 3214,DateTime.Now.Date)}));
    ...
    //        {
    //           new NormalTaskHolder("Test1", "this is testing1", true, Test1WeekPattern, 1, 3214,DateTime.Now.Date + TimeSpan.FromDays(-10) ),
    //           new NormalTaskHolder("Test2", "this is testing2", true, 0b00101010, 1, 3214,DateTime.Now.Date  + TimeSpan.FromDays(-10) )
    //        };
